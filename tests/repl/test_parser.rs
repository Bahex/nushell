...
#[case::string_int_string("a.0.b", Type::Int)]
#[case::string_string_int("a.b.0", Type::Int)]
#[test]
#[exp(CELL_PATH_TYPES)]
fn let_assign_record_cell_path_to_wrong_type(
    #[case] cell_path: &str,
    #[case] inferred_type: Type,
) -> Result {
    let mut tester = test();
    ...
    assert_matches!(
        err,
        ParseError::TypeMismatch(Type::String, found, _) if found == inferred_type
    );
    Ok(())
}
...
#[case::int("0.a.b", Type::list(Type::Int))]
#[case::int("0.a.b.0", Type::Int)]
#[case::string(
    "a",
    Type::list(Type::Record([
        ("b", Type::list(Type::Int))
...
#[case::string_int_string("a.0.b", Type::list(Type::Int))]
#[case::string_string("a.b", Type::list(Type::list(Type::Int)))]
#[case::string_string_int("a.b.0", Type::list(Type::Int))]
#[case::string_string_int_int("a.b.0.0", Type::Int)]
#[test]
#[exp(CELL_PATH_TYPES)]
...
#[case::int_string_string("0.a.b", Type::list(Type::Int))]
#[case::int_string_string_int("0.a.b.0", Type::Int)]
#[case::string(
    "a",
    Type::list(Type::Record([
        ("b", Type::list(Type::Int))
...
#[test]
fn redefine_def_should_not_panic() -> Result {
    let err = test().run("def def (=a|s)>").expect_parse_error()?;
    assert_matches!(err, ParseError::Unclosed(_, _));
    Ok(())
}
